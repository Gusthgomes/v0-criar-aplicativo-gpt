...
export async function POST(
  ...
  try {
    ...
    const { stop_type, sub_type, material_code, observations, duration_minutes } = body
    ...
    const result = await sql`
      INSERT INTO stops (test_id, stop_type, sub_type, material_code, observations, duration_minutes)
      VALUES (${testId}, ${stop_type}, ${sub_type || null}, ${material_code || null}, ${observations || null}, ${duration_minutes ?? null})
      RETURNING *
    `
